...
(function(exports) {
  ...
  exports.createTargetDataset = (function() {
    ...
    function createTargetDataset(commandHost, accessToken, targetFolder, name, schema, primaryKey, cb) {
      var url = util.format("%s/commandSync/resource/create/dataset", commandHost);
      var data = {};
